...
public class bj_3190_뱀_최민수 {
	...
	private static void increase(int[][] map, int[][] snake, int[][] snakeClone, int curX, int curY, int movX, int movY,
			boolean eatApple, int time, int length) {
