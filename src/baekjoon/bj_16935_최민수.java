...
public class bj_16935_최민수 {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < R; i++) {
			if (oper[i].equals("1")) map = one();
			else if (oper[i].equals("2")) two();
			else if (oper[i].equals("3")) three();
			else if (oper[i].equals("4")) four();
			else if (oper[i].equals("5")) five();
			else if (oper[i].equals("6")) six();
		}
